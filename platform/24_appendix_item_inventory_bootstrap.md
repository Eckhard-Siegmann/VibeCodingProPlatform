...
- **All current items use unified max_rating=5** for cognitive consistency in live assessments
- Labels are stored in: label_min, label_low_mid, label_mid, label_high_mid, label_max
- Convention: All 5-point items use all five labels (Poor, Fair, Good, Very Good, Excellent)
- **Scale expansion**: Items with max_rating ≤ 7 render as button scales; items with max_rating > 7 render as sliders (implemented in frontend/query/src/lib/components/assessment/ItemRow.svelte). Sliders use endpoint labels only and never display numeric values per Ch.26.2.1 to prevent anchoring bias in longitudinal assessments. The backend's scale consistency checker automatically groups items by scale and renders appropriately.
...
- item_id: **0d2b6f6a-28c3-4d8b-9af6-3f9f9f6c4d01**
  ...
  max_rating: **5**
  item_text: "Correctness: The solution meets the stated requirements (including edge cases) and behaves as intended."
...
- item_id: **8fa2e7a2-0e0a-4c6d-b8db-7b7a0c7e0a02**
  ...
  max_rating: **5**
  item_text: "Test support: Evidence (tests or equivalent checks) convincingly supports correctness."
...
- item_id: **c03a7f23-56df-4b65-a0a6-4b2a62fb0a03**
  ...
  max_rating: **5**
  item_text: "Readability: The code is easy to read and understand (naming, structure, local reasoning)."
...
- item_id: **7e51a8e5-2f7a-46b1-9a0e-85f8b7f48a04**
  item_key: **simplicity**
  max_rating: **5**
  item_text: "Simplicity: The solution avoids unnecessary complexity and bloat."
...
- item_id: **b0f1c2c6-9f5e-43ff-9d1d-3f1e884b2a05**
  item_key: **elegance**
  max_rating: **5**
  item_text: "Elegance: The solution uses fitting language constructs and exhibits a clean, teachable structure."
...
- item_id: **f6a94c2a-3a63-4cc3-9e4e-fc46c4c1aa06**
  ...
  max_rating: **5**
  item_text: "Extensibility: The design can accommodate likely requirement changes with minimal rework (without overengineering)."
  label_min: "Fragile"
...
- item_id: **1c88d55b-3d2d-4d2d-9f1b-6f27c5f80b07**
  ...
  max_rating: **5**
  item_text: "Completion: How much of the intended task scope was achieved."
...
- item_id: **a54c2b9a-6f30-4a9c-a1d1-4bd33f6e6a08**
  ...
  max_rating: **5**
  item_text: "Time efficiency: Given the time constraints, the approach produced strong progress per unit time."
...
- item_id: **d0fb0c0f-4f2e-4d2a-9f52-8fda13b7aa09**
  ...
  max_rating: **5**
  item_text: "Cognitive Ease: How would you rate the cognitive ease of understanding and supervising this process?"
  ...
  This maintains semantic equivalence while aligning with the unified scale approach where
  higher values always indicate "more" of the measured construct.

  **Implementation note**: If future items require slider format (max_rating > 5), they will automatically render as continuous sliders without numeric display per Ch.26.2.1.
...
- item_id: **2b6c0b5b-0a1f-4b5d-b5a4-4bd7e9a9aa10**
  ...
  max_rating: **5**
  item_text: "Clarity: The problem statement is clear and unambiguous."
...
- item_id: **5d6b1a32-9f1a-4a5a-bc3c-3e2d9b1caa11**
  ...
  max_rating: **5**
  item_text: "Acceptance criteria: The success conditions are explicit enough to judge outcomes."
  label_min: "Missing"
  label_low_mid: "Vague"
...
- item_id: **9b9f3b1a-2c3a-4cba-a56d-8f0c1d9caa12**
  ...
  max_rating: **5**
  item_text: "Testability: It is feasible to validate correctness via tests, checks, or reproducible procedures."
...
- item_id: **6f5b2c21-08b4-4c1a-9d7f-2fa6f1c2aa13**
  ...
  max_rating: **5**
  item_text: "Internal structure: The task is decomposed into coherent sub-tasks or milestones."
...
- item_id: **3d0e3c9a-5a61-4a55-8a8e-4d6b5a9eaa15**
  item_key: **complexity_suitability**
  max_rating: **5**
  item_text: "Complexity suitability: Is this problem appropriately sized for a event sprint? (Rate "Poor" if too trivial OR too complex)"
  label_min: "Poor"
  label_low_mid: "Fair"
  label_mid: "Good"
...
- item_id: **4a2f5e9c-7b4b-4b27-9f5e-4e8d1f9faa15**
  ...
  max_rating: **5**
  item_text: "Personal value: If completed, I would personally benefit from or use this outcome."
...
- item_id: **7b4f1a3d-5d9e-4bd1-8db5-5c9e1f0baa16**
  ...
  max_rating: **5**
  item_text: "General importance: This seems broadly valuable or important to the community."
...
- item_id: **1e9c2d7a-4c8f-4e27-8a1f-7a9b1c2caa17**
  item_key: **event_alignment**
  max_rating: **5**
  item_text: "Event alignment: This problem supports comparing agentic coding approaches and requirements-driven quality thinking."
...
- item_id: **0b7a9c2d-6d3e-4c2a-9a1f-3b7c9d1daa18**
  ...
  max_rating: **5**
  item_text: "Engagement: How intensively did you engage with this problem or solution before rating?"
...
- inventory_id: **7d2b0f3a-2c7f-4b1e-9a6c-0f4c1a9b0b01**
  ...
  name: "ProblemEval – Problem Quality & Hackathon Suitability"
...
- inventory_id: **3a1c7b2d-6e5f-4a3b-9a2d-1c6e7f8a0b02**
  ...
  name: "QualityGate – Moderator Pre-Screening"
...
- inventory_id: **4c9a2b1d-8f7e-4c1a-9b3e-2d7e8f9a0b03**
  ...
  name: "Pitch – Live Voting During Pitches"
  description: "Fast live rating during event pitches to guide selection."

- inventory_id: **9f0a1b2c-3d4e-4f5a-9b6c-3e4f5a6b0b04**
  inventory_key: **review_assessment**
  name: "Review – Post-Pitch / Post-Sprint Review"
...
- inventory_id: **2b3c4d5e-6f7a-4b8c-9d0e-4f5a6b7c0b05**
  ...
  name: "LessonsLearned – Delayed Reflection"
  description: "One-week-later reflection by PO using structured assessment items to evaluate problem quality after completion. This is distinct from the Lessons Learned Log (Ch.04), which captures freeform insights in a separate knowledge base."
